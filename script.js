document.addEventListener('DOMContentLoaded', () => {
    ...
    const resourceMap = {
        ...
        'superstore': 'images/Sales dashboard.png',
        'women': 'images/Partime dashboard.png',
        'jobportal': 'https://raji-44.github.io/jobHunt/',
        'neoweb': 'images/neoweb.png',
        'salesexcel': 'images/sales excel dashboard.png',

        // Certifications
        'ibm': 'images/TNSDC.png',
        'infosys': 'images/infosys.png',
        'besant_cert': 'images/besantcousre.jpeg',
        'novitech': 'images/novitech.png',
        'ics': 'images/tcs.png',
        'swati': 'images/hackathon.jpeg',

        // Internships
        'monk': 'images/internship.jpeg',
        'besant': 'images/beasantinternship.jpeg'
    };
    ...
    const projectsData = {
        ...
        'salesexcel': {
            title: 'Sales & Performance Dashboard (Global Vehicles)',
            desc: [
                'Built a multi-year (2023–2025) Excel dashboard tracking $9.8M profit across 19 countries, 92 customers, and 2,823 products',
                'Used Excel formulas, pivot tables, and charts to segment performance by product category (Classic Cars, Motorcycles, Ships, etc.)',
                'Delivered year-over-year trend analysis with slicers and dynamic visuals entirely within Excel'
            ],
            tags: ['Microsoft Excel', 'Data Analysis', '2026'],
            icon: 'fa-globe'
        }
    };
    ...
    const openModal = (data, category, key) => {
        ...
        if (category === 'project') {
            ...
            } else if (key === 'salesexcel') {
                modalBtn.textContent = 'View Excel Dashboard';
            } else {
        ...
        // Hide button for specific projects if no link/file is available
        if (key === 'neoweb') {
